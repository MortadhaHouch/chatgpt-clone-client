...
Command: npx gltfjsx@6.5.2 .\public\3d\hologram_earth_dark_land.glb 
...
export default function Earth(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/3d/hologram_earth_dark_land.glb')
  const { actions } = useAnimations(animations, group)
  return (
    <group scale={[2.5,2.5,2.5]} ref={group} {...props} dispose={null}>
...
useGLTF.preload('/3d/hologram_earth_dark_land.glb')
